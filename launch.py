...
def main():
    ...
    if sys.platform == 'win32':
        ...
        strategy = 'ddp'
        # strategy = 'ddp_find_unused_parameters_false' # originally set to false to acclerate the training
    ...
    if args.train:
        ...
        if system.config.predict.with_background:
            system.config.model.background = 'black'
        predictions = trainer.predict(system, datamodule=dm, ckpt_path=args.resume)
